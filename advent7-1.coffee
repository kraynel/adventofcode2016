...
hasPair = (s) ->
  pair = /([a-z])([a-z])\2\1/.test s
  hasFour = /([a-z])\1\1\1/.test s
  pair and not hasFour
...
testString = (s) ->
  ...
  while (inner = innerRegex.exec(s))?
    ...
    inners.push hasPair inner[1]

  outers = []
  outerRegex = /([a-z]*)\[/g
  while (outer = outerRegex.exec(s))?
    console.log 'found outer', outer[1]
    outers.push hasPair outer[1]

  last = /\]([a-z]*)$/.exec(s)?[1]
  if last?
    console.log 'found outer', last
    outers.push hasPair last

  console.log inners
  console.log outers
  return false if _.some inners
  _.some outers

# console.log testString 'azezaezae[azeaze]azkjea[azea]'
